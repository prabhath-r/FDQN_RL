...
class DQN(nn.Module):
    def __init__(self, action_size):
        ...
        self.fc1_input_size = self._calculate_fc1_input_size() #fully connected layer size
    ...
    def _calculate_fc1_input_size(self):
        with torch.no_grad():
            ...
            # print(f"fc1 input size: {output_size}")  # Debugging print
            
            return output_size

    def forward(self, x):

        # print(f"input layer shape: {x.shape}")  # Debugging print
